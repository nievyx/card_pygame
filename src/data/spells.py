...
fireball = DamageSpell(name='Fireball',
                       strength=12,
                       mana_cost=5,
                       icon='assets/icons/fire_spell_2.png')
